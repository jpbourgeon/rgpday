...
const replaceJssClassNames = (elements) => {
  elements.forEach((element) => {
    ...
    // our JSS setup generates the class names that follow this format:
    // {randomId}-{ruleName}-{Counter}
    // the non-deterministic part of it is "-{ruleName}-{Counter}"
    ...
    const deterministicClassNames = classNameProp
      ...
      .map((className) => {
        ...
        return className.substring(secondLastDashPosition + 1)
      })
